        ...
        <div className="grid md:grid-cols-3 gap-12 md:gap-8 mb-12">
          ...
          <div>
            ...
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 mt-6 px-6 py-3 border border-primary text-primary text-sm tracking-wide hover:bg-primary hover:text-primary-foreground transition-all duration-300"
            >
              <svg
                className="w-5 h-5"
                viewBox="0 0 24 24"
